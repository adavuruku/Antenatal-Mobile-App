...
public class MonthlyTips extends AppCompatActivity implements MonthlyPage.OnFragmentInteractionListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_monthly_tips);
        Toolbar toolbar = findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        SubtitleCollapsingToolbarLayout t = findViewById(R.id.collapsing);
        t.setSubtitle("Monthly Pregnancy Tips.");
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return MonthlyPage.getInstance(position);
        }
        ...
        @Override
        public int getCount() {
            return dbColumnList.monthTabs.length;
        }

        @Override
        public CharSequence getPageTitle(int position) {
            return dbColumnList.monthTabs[position];
        }
    }
}
