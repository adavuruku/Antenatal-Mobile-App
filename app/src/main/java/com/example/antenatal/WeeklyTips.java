...
public class WeeklyTips extends AppCompatActivity implements WeeklyPage.OnFragmentInteractionListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_weekly_tips);
        ...
        t.setSubtitle("Weekly Pregnancy Tips.");
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return WeeklyPage.getInstance(position);
        }
