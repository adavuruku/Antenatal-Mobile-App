...
public class NutritionTips extends AppCompatActivity implements NutritionPage.OnFragmentInteractionListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nutition_tips);
        ...
        t.setSubtitle("Weekly Pregnancy Nutrition Tips.");
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return NutritionPage.getInstance(position);
        }
        ...
        @Override
        public int getCount() {
            return dbColumnList.weekTabs.length;
        }

        @Override
        public CharSequence getPageTitle(int position) {

            return dbColumnList.weekTabs[position];
        }
    }
}
